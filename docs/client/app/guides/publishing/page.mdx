export const metadata = {
  title: "Publishing | Guides | BCDS",
  description: "This document explains how to publish `@BuildCanada/bcds` to the npm registry using trusted publishing (OIDC/provenance).",
};
