export const metadata = {
  title: "Button | Components | Build Canada Design System",
  description: "Build Canada Design System's Button component documentation. Button is a versatile button component that supports multiple variants, sizes, and icon configurations.",
};
