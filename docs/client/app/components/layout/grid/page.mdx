export const metadata = {
  title: "Grid | Components | Build Canada Design System",
  description: "Build Canada Design System's Grid component documentation. Grid is a responsive CSS grid layout component with customizable columns and gaps.",
};
